...
CPickup::CPickup(CGameWorld *pGameWorld, int Type, vec2 Pos, int MapID)
...
void CPickup::Tick()
{
	...
	CCharacter *pChr = (CCharacter *)GameWorld()->ClosestEntity(m_Pos, 20.0f, CGameWorld::ENTTYPE_CHARACTER, 0, GetMapID());
