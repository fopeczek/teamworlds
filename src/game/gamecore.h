...
#undef MACRO_TUNING_PARAM
    ...
    int
    PossibleTunings(const char *pStr, IConsole::FPossibleCallback pfnCallback = IConsole::EmptyPossibleCommandCallback,
                    void *pUser = 0);
};
...
public:
    ...
    void Init(CWorldCore *pWorld, CCollision *pCollision, int Team, int MapID = IServer::MainMapID,
              CPlayerClass player_Class = CPlayerClass());
